...
Very recently, I’ve encountered an article wrote by Jane Zhang, an independent data visualization designer, about [why she’s finally learning to draw](https://janezhang.ca/posts/why-im-learning-to-draw/){:target="_blank"}. Jane is following the lessons from [Drawabox.com](https://drawabox.com/), and shared a video from their instructor that perfectly describes **what happens every time I’m faced with a blank page**.

https://youtu.be/mgl6Ll3K3gw

It’s not lazyness, or lack of fantasy: **the fear of failure, and the need to be in control always kept me**. I could think of other instances where the same fear influenced me: work and photography.
...
![Superimposed lines, page 1](/assets/images/superimposed-lines_1.webp)
![Superimposed lines, page 2](/assets/images/superimposed-lines_2.webp)
