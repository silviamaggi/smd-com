    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        <header>
          ...
          <div class="head">
            <div class="avatar">
              <img src="/assets/images/silviamaggi-avatar.png" alt="Avatar of Silvia Maggi"/>
            </div>
            <div class="description">
              <p><xsl:value-of select="/rss/channel/description"/></p>
              <p><a hreflang="en"><xsl:attribute name="href"><xsl:value-of select="/rss/channel/link"/></xsl:attribute>Visit the newsletter archive &#x2192;</a></p>
            </div>
          </div>
        </header>
        <main>
